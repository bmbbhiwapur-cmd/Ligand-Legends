...
"""
    ...
    study_note = f"""=========================================
LIGAND LEGENDS: IN SILICO DOCKING REPORT
=========================================
Generated by Tech Logic Core Systems (TLCS)

[ RESULT SUMMARY ]
Drug/Ligand Name  : {drug_n}
Protein Target    : {prot_n}
Disease Category  : {disease_n}
Binding Affinity  : {st.session_state.affinity_score} kcal/mol
Rank Evaluation   : {rank}

[ MACROMOLECULE DETAILS ]
Organism          : {st.session_state.protein_meta.get('organism', 'N/A')}
Experimental Method: {st.session_state.protein_meta.get('method', 'N/A')}
...
Molecular Weight  : {st.session_state.ligand_meta.get('mw', 'N/A')}
...
"""
    ...
    st.caption("📸 **Tip:** To save an image of the 3D molecule, simply long-press (or right-click) on the 3D viewer above and select 'Save Image'!")
